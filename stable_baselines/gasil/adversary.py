...
class TransitionClassifier(object):
    ...
    def learn(self, observations, actions, buffer, batch_size):
        """
        ...
        with self.session.as_default():
            ...
            for ob_batch, ac_batch in dataset.iterbatches((observations, actions),
                                                          include_final_partial_batch=False,
                                                          batch_size=batch_size,
                                                          shuffle=True):
                ob_expert, ac_expert, _ = buffer.sample(batch_size=batch_size)
                ...
                *newlosses, grad = self.lossandgrad(ob_batch, ac_batch, ob_expert, ac_expert)  # , sess=self.model.sess
