...
from stable_baselines.sil.util import SumSegmentTree, MinSegmentTree, discount_with_dones
...
class SelfImitation(object):
    ...
    def __init__(self, model_ob, model_vf, model_entropy,
            fn_value, fn_neg_log_prob, ac_space,
            ...
            alpha=0.6, beta=1.0):
        # Removed:
        # fn_reward: function applied to the reaward before appending to Buffer
        # fn_obs: function applied to the reaward before appending to Buffer
